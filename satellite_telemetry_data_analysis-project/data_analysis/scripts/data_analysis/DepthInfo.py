...
from .staticMethods import convertUnixTimeFromString
...
class DepthInfo:
    ...
    def __init__(self, npEntry):
        ...
        #self.approxAQTimeLongitute = npEntry[ColumnReferences.DEPTH_APPROX_AQ_TIME_LONG]
        #self.approxAQTimeLatitude = npEntry[ColumnReferences.DEPTH_APPROX_AQ_TIME_LAT]
