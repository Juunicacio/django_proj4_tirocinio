...
# #json
# jsonGpsData_tag_710333a = responseGpsData_tag_710333a.json()
# jsonGpsData_tag_710348a = responseGpsData_tag_710348a.json()

# jsonDepthData_tag_710333a = responseDepthData_tag_710333a.json()
# jsonDepthData_tag_710348a = responseDepthData_tag_710348a.json()
...
# WORKING WITH JSON FROM GITHUB, THE NUMBER 2- 
# (If you want to see the data of json from script, see turtles_deep_data_dashboard.py)
